...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Nov 2023 pada 04.03
...
CREATE TABLE `detail_penjualan_barang` (
  ...
  `kode_brg` varchar(50) NOT NULL,
  `qty_customer` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `customer`
  ADD CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`id_customer`) REFERENCES `penjualan_barang` (`id_customer`);

--
-- Ketidakleluasaan untuk tabel `detail_penjualan_barang`
--
ALTER TABLE `detail_penjualan_barang`
  ADD CONSTRAINT `detail_penjualan_barang_ibfk_1` FOREIGN KEY (`no_jual`) REFERENCES `penjualan_barang` (`no_jual`),
  ADD CONSTRAINT `detail_penjualan_barang_ibfk_2` FOREIGN KEY (`kode_brg`) REFERENCES `barang` (`kode_brg`);
COMMIT;
